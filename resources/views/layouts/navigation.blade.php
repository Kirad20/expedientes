        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-nav-dropdown title="Apps" align="right" width="48">
                        @can('view-any', App\Models\Documento::class)
                        ...
                        @endcan
                        @can('view-any', App\Models\Expediente::class)
                        <x-dropdown-link href="{{ route('expedientes.index') }}">
                        Expedientes
                        </x-dropdown-link>
                        @endcan
                </x-nav-dropdown>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                ...
                @can('view-any', App\Models\Documento::class)
                <x-responsive-nav-link href="{{ route('documentos.index') }}">
                Documentos
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\User::class)
                ...
                @endcan
                @can('view-any', App\Models\Expediente::class)
                <x-responsive-nav-link href="{{ route('expedientes.index') }}">
                Expedientes
                </x-responsive-nav-link>
                @endcan
